...
#ifndef SCAN_MATCHING__TRANSLATION_DELTA_COST_FUNCTOR_2D_HPP_
#define SCAN_MATCHING__TRANSLATION_DELTA_COST_FUNCTOR_2D_HPP_
...
public:
  ...
  {
    residual[0] = m_scaling_factor * (pose[0] - m_x);
    residual[1] = m_scaling_factor * (pose[1] - m_y);
    return true;
  }
...
private:
  ...
  : m_scaling_factor(scaling_factor),
    m_x(target_translation.x()),
    m_y(target_translation.y()) {}
...
#endif  // SCAN_MATCHING__TRANSLATION_DELTA_COST_FUNCTOR_2D_HPP_
