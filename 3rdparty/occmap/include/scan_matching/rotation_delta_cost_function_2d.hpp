...
#ifndef SCAN_MATCHING__ROTATION_DELTA_COST_FUNCTION_2D_HPP_
#define SCAN_MATCHING__ROTATION_DELTA_COST_FUNCTION_2D_HPP_
...
public:
  ...
  {
    residual[0] = m_scaling_factor * (pose[2] - m_angle);
    return true;
  }
...
private:
  ...
  RotationDeltaCostFunctor2D & operator=(
    const RotationDeltaCostFunctor2D &) = delete;
...
#endif  // SCAN_MATCHING__ROTATION_DELTA_COST_FUNCTION_2D_HPP_
